...
import type { TConserveAdapter, THttpsAdapter, TNeedsAdapter } from './adapter.types';
import type {
  IHttpsRequest,
  IMessagesConfig,
  TCacheOptions,
...
> extends Record<string, IModule> {
  ...
  store: Store<S>;
  token: Token<T>;
  needs: Needs<T, THttpsAdapter<T, S, RM>, S, N, TConserveAdapter<T, S, RM>, TNeedsAdapter<T, S, RM>>;
